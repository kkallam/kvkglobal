			...
			templateUrl: 'partial-events.html'
				...
				.state('events.goGetters', {
					...
					templateUrl: 'partial-events-goGetters.html'
						...
						.state('events.goGetters.uploadGoGetters', {
							url: '/uploadGoGetters',
							templateUrl: 'partial-events-goGetters-upload.html'
						})
						.state('events.goGetters.viewGoGetters', {
							url: '/viewGoGetters',
							templateUrl: 'partial-events-goGetters-view.html'
						})
				.state("events.contactsForm", {
					url: '/contactsForm',
					templateUrl: 'partial-events-contacts.html'
				})
